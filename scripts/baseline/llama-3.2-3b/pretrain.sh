...
DATA_PATH="/wanghaixin/MolMoE/Molecule-oriented_Instructions/chem_data_cleaned.csv"
PROJECTOR="naive_linear"
TASK="pub_chem"
MODEL_PATH="/wanghaixin/MolMoE/checkpoints/Llama-3.2-3B-Instruct"
REMARK=""
...
deepspeed --include localhost:0,1 main.py \
    ...
    --split_eval False \
    --eval_on_start False \
    --logging_dir /wanghaixin/MolMoE/tf-logs/llava-$TASK-$GRAPH_TOWER-$MODEL_VERSION-$PROJECTOR-$REMARK \
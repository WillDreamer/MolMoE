...
deepspeed main.py \
    ...
    --pretrain_mm_mlp_adapter /root/autodl-tmp/MolMoE/_checkpoints/pretrain/llava-pub_chem-himol-llama3-1b-multilevel_type1-projector-test/checkpoint-30690/mm_projector.bin \
    --bf16 True \

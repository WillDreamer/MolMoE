    ...
    with open(eval_result_file) as f:
        ...
        for i, result in enumerate(results):
            ...
            if "HOMO" in prompt and "LUMO" not in prompt:
                data_dict["homo_gts"].append(float(gt))
                data_dict["homo_preds"].append(float(pred))
            elif "HOMO" not in prompt and "LUMO" in prompt:
                data_dict["lumo_gts"].append(float(gt))
                data_dict["lumo_preds"].append(float(pred))
            elif "HOMO" in prompt and "LUMO" in prompt:
                data_dict["gap_gts"].append(float(gt))
                data_dict["gap_preds"].append(float(pred))
            else:

...
def MoEPhiDecoderLayer_forward(self):
    def forward(
        ...
        outputs += (moe_losses,)  # append moe loss to outputs
...
class CustomPhi3Config(Phi3Config):
    """
    From pretrained to generate Phi3Config, and set moe config manually
    """
    model_type = "cutom_phi3"
    def __init__(
        self, 
        moe_enable=False,
        moe_mode='sparse',
        ...
        **kwargs
        ...
        if self.moe_config['moe_enable'] == True:
            print("Using MoE, Config is: ", self.moe_config)
    


class CustomPhi3DecoderLayer(nn.Module):
    def __init__(self, config: CustomPhi3Config, layer_idx: int):
        super().__init__()
...
class CustomPhi3PreTrainedModel(PreTrainedModel):
    config_class = CustomPhi3Config
    base_model_prefix = "model"
    supports_gradient_checkpointing = True
    _no_split_modules = ["CustomPhi3DecoderLayer"]
...
class CustomPhi3Model(CustomPhi3PreTrainedModel):
    """
    ...
    def __init__(self, config: CustomPhi3Config):
    ...
    def _supports_sdpa(self):
        ...
        SDPA or not.
        """
        return Phi3ForCausalLM._supports_sdpa
...
class CustomPhi3ForCausalLM(CustomPhi3PreTrainedModel, GenerationMixin):
